...
const blood_particles = preload("res://Particles/Blood/blood_particles.tscn")
...
var hurt: bool = false
#coins utils
const COINS = preload("res://Items/Coins/coins.tscn")
var instance

func set_stats(new_level: int) -> void:
	level = new_level
	max_health = pow(2, level) + BASE_HEALTH - 1
	health = max_health
...
func update_bar() -> void:
	enemy_health_bar.set_max_health(max_health)
