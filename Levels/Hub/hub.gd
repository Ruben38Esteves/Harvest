...
func primary_picked():
	...
	if secondary_picked_bool:
		get_tree().change_scene_to_file("res://Levels/Crypt/world.tscn")
...
func _on_play_shotgun_body_entered(body):
	if body.name == "Player":
		global.primary_weapon_path = "res://Weapons/Shotgun/shotgun.tscn"
		primary_picked()

func _on_play_rifle_body_entered(body):
	if body.name == "Player":
		global.primary_weapon_path = "res://Weapons/Rifle/rifle.tscn"
		primary_picked()


func _on_play_gun_body_entered(body):
	if body.name == "Player":
		global.secondary_weapon_path = "res://Weapons/HandGun/hand_gun.tscn"
		print(primary_picked_bool)
		print(secondary_picked_bool)
		secondary_picked()
...
func _on_play_poison_body_entered(body):
	if body.name == "Player":
		global.secondary_weapon_path = "res://Weapons/PoisonFlask/poison_flask.tscn"
		print(primary_picked_bool)
		print(secondary_picked_bool)
		secondary_picked()
